...
_See code: [src/commands/api/request/graphql.ts](https://github.com/salesforcecli/plugin-api/blob/1.3.31/src/commands/api/request/graphql.ts)_
...
_See code: [src/commands/api/request/rest.ts](https://github.com/salesforcecli/plugin-api/blob/1.3.31/src/commands/api/request/rest.ts)_
